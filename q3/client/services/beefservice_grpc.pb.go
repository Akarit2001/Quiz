...
const (
	Beef_Summary_FullMethodName = "/service.Beef/Summary"
)
...
type BeefClient interface {
	Summary(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*BeefSummaryResponse, error)
}
...
func (c *beefClient) Summary(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*BeefSummaryResponse, error) {
	out := new(BeefSummaryResponse)
	err := c.cc.Invoke(ctx, Beef_Summary_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type BeefServer interface {
	Summary(context.Context, *EmptyRequest) (*BeefSummaryResponse, error)
...
func (UnimplementedBeefServer) Summary(context.Context, *EmptyRequest) (*BeefSummaryResponse, error) {
...
func _Beef_Summary_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(BeefServer).Summary(ctx, req.(*EmptyRequest))
	}
